...
def iniciar():
        ...
        mixer.music.play()
#######
        fig = Figure(figsize=(2.9, 3.1), dpi=100)
        #fig.title("Signal live")
        TLabel=Label(ventana,text="En tiempo real",font="Helvetica 16 bold")
        XLabel=Label(ventana,text="Muestras",font="Helvetica 16 bold")
        YLabel=Label(ventana,text="uV",font="Helvetica 16 bold")
        
        canvas = FigureCanvasTkAgg(fig, master=ventana)  # A tk.DrawingArea.
        canvas.get_tk_widget().place(x=360,y=30)
...
#####
        ht=5
        wt=11
        Led=Button(ventana,bg='white',font="Helvetica 16 bold",height = ht,width=wt)
        Led.place(x=10, y=10)
        Regresar=Button(ventana,bg='gray',font="Helvetica 16 bold",height = ht,width=wt)
        Regresar.place(x=160, y=10)
        OPC1=Button(ventana,text="Responder",font="Helvetica 16 bold",bg='yellow',height = ht,width=wt)   
        OPC1.place(x=10, y=160)
        OPC2=Button(ventana,text="Preguntar",font="Helvetica 16 bold",bg='purple',height = ht,width=wt)
        OPC2.place(x=160, y=160)
        OPC3=Button(ventana,text="Controlar",font="Helvetica 16 bold",bg='red',height = ht,width=wt)
        OPC3.place(x=10, y=310)
        OPC4=Button(ventana,text="Jugar",font="Helvetica 16 bold",bg='blue',height = ht,width=wt)
        OPC4.place(x=160, y=310)
        TLabel.place(x=420,y=0)
        XLabel.place(x=450,y=360)
        YLabel.place(x=320,y=180)
        #plt.figure(1)
        d=0
        fm=1022
        paso=511
